...
public class LeftMiddleBtPanel extends JPanel implements ActionListener,
	...
	private JButton jbtMagicEmotion = new JButton(
			createImageIcon("MagicEmotion.jpg"));
	...
	public LeftMiddleBtPanel(JTextAreaEx sendPanel, JTextAreaEx recvTextArea) {
		...
		jbtMagicEmotion.setPreferredSize(new Dimension(btSize, btSize));
		// jbtMagicEmotion.addActionListener(this);
		jbtMagicEmotion.setToolTipText(UniResources
				.getString("msk.LeftMiddleBtPanel.MagicEmotionti"));
